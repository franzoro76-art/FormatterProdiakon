        ...
        {isMenuOpen && (
          <div className="absolute right-0 mt-2 w-48 bg-white border border-slate-200 rounded-xl shadow-2xl py-2 z-50 overflow-hidden">
            ...
            <a
              ...
              className="w-full flex items-center space-x-3 px-4 py-3 transition-colors text-slate-700 hover:bg-slate-50 hover:text-black border-l-2 border-transparent"
            >
              <i className="fa-brands fa-android w-5 text-center text-[#3DDC84]"></i>
              <span className="font-medium text-sm">Android APK</span>
            </a>
          </div>
        )}
      </div>
